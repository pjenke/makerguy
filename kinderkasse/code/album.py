...
# Ein Album ist ein Kontainer für die Informationen eines Albums in der MusicBox
# Anwendung: Name des Albums und Titelliste. 
class Album():    
    
    def __init__(self, albumname, titleliste):
        self.albumname = albumname
        self.titelliste = titleliste